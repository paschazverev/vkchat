package ru.nacu.commons.loader;
...
/**
 * Скопировал из compatibility + внес небольшие изменения
 */
public abstract class AsyncTaskLoader<D> extends Loader<D> {
    ...
    public AsyncTaskLoader(Context context, Uri notificationUri) {
        super(context);
        if (notificationUri != null) {
            observer = new ForceLoadContentObserver();
            context.getContentResolver().registerContentObserver(notificationUri, true, observer);
        } else {
            observer = null;
        }
    }
