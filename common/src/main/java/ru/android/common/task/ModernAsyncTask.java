...
public abstract class ModernAsyncTask<Params, Progress, Result> {
    ...
    public enum Status {
        ...
        RUNNING,
        /**
         * Indicates that {@link ModernAsyncTask#onPostExecute} has finished.
         */
        FINISHED,
    }
    ...
    public ModernAsyncTask() {
        ...
        mFuture = new MyFutureTask(mWorker);
    }
    ...
    private class MyFutureTask extends FutureTask<Result> implements Comparable<HasPriority>, HasPriority {
        public MyFutureTask(Callable<Result> resultCallable) {
        ...
        public int getTaskPriority() {
            return ModernAsyncTask.this.getTaskPriority();
        }
    }
     ...
     *                               {@link ModernAsyncTask.Status#RUNNING} or {@link ModernAsyncTask.Status#FINISHED}.
     */
